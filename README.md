...
> **Linux 智能端口诱捕与内核级主动防御系统**  
> 专为 Linux 服务器打造的主动安全防御网关。支持自定义多端口与大范围诱饵探针，一旦感知未授权端口扫描或恶意嗅探，直接联动 Linux 内核下发 `iptables` / `ip route blackhole` 实施毫秒级硬丢包阻断，并提供纯原生的轻量 Web 控制台与威胁溯源大屏。
